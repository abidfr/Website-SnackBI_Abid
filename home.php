...
$result = mysqli_query($database->koneksi,"SELECT  * FROM produk");
$data = mysqli_query($database->koneksi,"SELECT * FROM services");
?>
...
<head>
  ...
  <title>Website SnackBI Food</title>
</head>
...
<body>
  ...
  <header class="l-header" id="header">
    <nav class="nav bd-container">
      <a href="#">
          <img src="assets/img/icon.png" height="100" width="200">
      </a>
      ...
      <div class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          ...
          <li class="nav__item">
            <a href="logout.php" class="ml-3 form-inline my-2 my-lg-0 btn btn-secondary">LOGOUT</a>
          </li>
  ...
  <main class="l-main">
    ...
    <section class="home" id="home">
      <div class="home__container bd-container bd-grid">
        <div class="home__data">
          <h1 class="home__title">We ready to supply snackbi food for you anytime</h1>
          <h3 class="home__subtitle">Our job is to filling your tummy with delicious food and with fast and free
            delivery the week.</h3>
          <a href="#about" class="button">Get Started</a>
          <a href="#menu" class="button">Now Menu</a>
        </div>

        <img src="assets/img/image.png" height="1000" width="1000" alt="">
      </div>
    </section>
      ...
      <div class="about__container  bd-grid">
        <div class="about__data">
          <div class="fs-3 text-white">
            <span class="section-subtitle about__initial fs-2">About us</span></div>
          <h2 class="section-title about__initial">We cook the best <br> SnackBI Food</h2>
      ...
      <div class="fs-3 text-white text-center">
          ...
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" style="color: black;" id="exampleModalLabel">Tambah Menu</h5>
              </div>
              <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <button type="submit" class="btn mt-2  btn-primary" name="send"
                    style="display: flex;justify-content: start;">Simpan</button>
                </form>
              </div>
        ...
        <div class="services__container  bd-grid">
          ...
          <div class="services__content">
            ...
            <h3 class="services__title mt-3"><?=  $datas['title'];  ?></h3>
            <p class="services__description"><?=  $datas['pesan'];  ?></p>
            <div class="main-center">
              <a href="" class="btn btn-success" data-toggle="modal" data-target="#main<?= $datas['id_services'] ?>">
                <i class="fas fa-pen"></i>
              </a>
              <a href="hapus_data.php?id=<?=  $datas['id_services'];  ?>" class="btn btn-danger"
          ...
          <div class="services__content">
            ...
            <p class="services__description">We offer our clients excellent quality services for many years, with the
              best and delicious food in the city.</p>
          </div>
      ...
      <div class="fs-3 text-white text-center">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <button type="submit" class="btn mt-2  btn-primary" name="simpan"
                    style="display: flex;justify-content: start;">Simpan</button>
                </form>
              </div>
              <div class="modal-footer">
        ...
        <div class="menu__container bd-grid">
          ...
          <div class="menu__content">
            <div class="main_center">
              <div style="width: 100px;height: 100px;">
                <img src="assets/img/<?=  $row['img'];  ?>" alt="" class="menu__img rounded-circle"
                  style="width: 100%;height: 100%;border-radius: 50px;object-fit: cover;">
              </div>
            </div>
            <h3 class="menu__name mt-3"><?=  $row['nama'];  ?></h3>
            <span class="menu__name"><?=  $row['descripsi'];  ?></span>
            <span class="menu__preci">Rp. <?=  $row['harga'];  ?></span>
            <div class="d-flex mt-2">
              <a href="" class="btn btn-success" data-toggle="modal" data-target="#edit<?= $row['id_produk'] ?>">
                <i class="fas fa-pen"></i>
              </a>
              <a href="hapus.php?id=<?=  $row['id_produk'];  ?>" class="btn btn-danger" style="margin-left: 10px;">
                <i class="fas fa-trash"></i>
              </a>
            </div>
          ...
          <!-- <div class="menu__content">
            ...
            <h3 class="menu__name">Risole Mozarella</h3>
          ...
          <div class="menu__content">
            ...
            <h3 class="menu__name">Telor Gulung</h3>
            <span class="menu__detail">Delicious dish</span>
            <span class="menu__preci">15.000</span>
            <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
          </div> -->
        </div>
    </section>
      ...
      <div class="app__container">
        <div class="app__data">
          <div class="text-white text-center">
            <h2 class="section-subtitle app__initial" style="text-align: center;">Testimonial</h2>
            <h2 class="section-title app__initial" style="text-align: center;">Testimoni Pelanggan</h2>
          </div>
          <p class="app__description" style="text-align: center; font-size: 20pt;">Flexibleshoping, sfae money</p>
                ...
                <div class="testimonial pt-5 pb-5">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <img src="assets/img/zhafif.jpeg" class="rounded-circle" width="90%">
                      </div>
                      <div class="col-md-7 text-justify font-italic">
                        <h4>Favian Zhafif Arkan <small>- CEO PT. Pencari Ikan Cilacap</small></h4>
                        Saya sangat suka dengan Restaurant ini, fasilitas dan berbagai makanan enak dan murah ,
                        Terjangkau di semua darah, adapun makanan laut lainnya, seafood dan berbagai minuman enak dan
                        lezat, Saya suka dengan Restaurant Ini. CILACAP MEGA RESTO THE BEST.
                      </div>
                      <div class="col-md-2"></div>
                    </div>
                  </div>
                ...
                <div class="testimonial pt-5 pb-5">
                  <div class="container">
                    <div class="row">
                      <div class="col-md-2"></div>
                      <div class="col-md-2">
                        <img src="assets/img/faizgledek.jpeg" class="rounded-circle" width="90%">
                      </div>
                      <div class="col-md-7 text-justify font-italic">
                        <h4>Faiz Atallariq Maulana <small>- Direktur Pencari makan Mania</small></h4>
                        Makanan yang disajikan sangat menarik dan lezat. dengan beragamnya menu yang ada menjaga
                        konsistensi rasa adalah hal yang sangat penting ,ini sudah ketiga kalinya saya datang dan saya
                        merasa sangat puas dengan makanannya ditambah tempatnya yang milenials dan instagramable sangat
                        cocok dengan saya yang suka berfoto.
                      </div>
                      <div class="col-md-2"></div>
                    </div>
                  </div>
                ...
                <div class="testimonial pt-5 pb-5">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-7 text-justify font-italic">
                        <h4>Faiz Guntur <small>- Manager Kesetiaan Sejati</small></h4>
                        Berbagai fasilitas dan hiburan yang ada menambah nilai plus dari restoran ini disamping
                        makanannya yang sangat beragam dan lezat. saya benar benar merasa nyaman di restoran ini.
                      </div>
                      <div class="col-md-2"></div>
                    </div>
                  </div>
          ...
          <div class="carousel-item">
            <img src="assets/img/faizgledek.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/img/faizgledek.jpeg" class="d-block w-100" alt="...">
          </div>
    ...
    <!--========== CONTACT US ==========-->
    <section class="contact section bd-container" id="contact" style="justify-content: center;">
      <div class="contact__container" style="margin: auto;">
        <div class="contact__data">
          <div class=" text-white " style="margin: auto;">
            <span class="section-subtitle contact__initial" style="text-align: center; font-size: 25pt;">Let's
              talk</span>
            <p class="contact__description text-center" style="text-align: center; font-size: 20pt;">If you want to
              reserve a table in our restaurant, contact us and we will attend you quickly, with our 24/7 chat service.
            </p>
          </div>
          <form action="" class="p-3" method="POST"  style="background-color: #00acc1;">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group mt-3">
                <label for="" class="text-white">Pesan</label>
                  <textarea name="pesan" id="pesan" cols="30" rows="8" class="form-control" placeholder="Pesan"></textarea>
                </div>
                </div>
              </div>
      ...
      <form method="post" action="">
        ...
        <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group mt-3">
                <input type="text" name="txtEmail" class="form-control" required placeholder="Your Email *" value="" />
              </div>
              <div class="form-group mt-3">
                <input type="text" name="txtPhone" class="form-control" required placeholder="Your Phone Number *" value="" />
              </div>
              <div class="form-group mt-3">
                <button type="submit"  class="btnContact">Kirim</button>
              </div>
            </div>
          <div class="col-md-6">
            <div class="form-group mt-3">
  ...
  <footer class="footer section bd-container">
    <div class="footer__container bd-grid">
      <div class="footer__content">
        <a href="#" class="footer__logo">SnakBI Food</a>
        <span class="footer__description">Online Shop</span>
        <div>
          <a href="https://www.facebook.com/abid.nakzz.3" class="footer__social"><i class='bx bxl-facebook'></i></a>
          <a href="https://www.instagram.com/abidfaddd_/" class="footer__social"><i class='bx bxl-instagram'></i></a>
          <a href="https://twitter.com/abidfaddd?s=08" class="footer__social"><i class='bx bxl-twitter'></i></a>
        </div>
      </div>
      ...
      <div class="footer__content">
        ...
        <ul>
          ...
          <li>Jl. Kebon Sawo, Kesugihan</li>
          <li>087705450381</li>
          <li>snackbifood@gmail.com</li>
        </ul>
      </div>
    </div>

    <p class="footer__copy">&#169; 2021 SnakBI. All right reserved</p>
  </footer>
  <?php foreach($result as $rows) : ?>
  <div class="modal fade" id="edit<?= $rows['id_produk'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" style="color: black;" id="exampleModalLabel">Edit Menu</h5>
        </div>
        <div class="modal-body">
          <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?=  $rows['id_produk'];  ?>">
            <input type="hidden" name="img_lama" value="<?=  $rows['img'];  ?>">
            <div class="form-group">
              <label for="nama">Nama</label>
              <input type="text" class="form-control" value="<?=  $rows['nama'];  ?>" id="nama" name="nama" required>
            </div>
            <div class="form-group">
              <label for="descripsi">Deskripsi</label>
              <textarea class="form-control" id="descripsi" name="descripsi"
                required><?=  $rows['descripsi'];  ?></textarea>
            </div>
            <div class="form-group mt-2">
              <label for="harga">Harga</label>
              <input type="number" class="form-control" value="<?=  $rows['harga'];  ?>" id="harga" name="harga"
                required>
            </div>
            <div class="form-group mt-2">
              <label for="file">Gambar</label>
            ...
            <button type="submit" class="btn mt-2  btn-primary" name="edit"
              style="display: flex;justify-content: start;">Simpan</button>
          </form>
        </div>
        <div class="modal-footer">
  ...
  <div class="modal fade" id="main<?= $datar['id_services'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" style="color: black;" id="exampleModalLabel">Edit Services</h5>
        </div>
        <div class="modal-body">
          <form action="" method="POST" enctype="multipart/form-data">
            <input type="hidden" value="<?=  $datar['id_services'];  ?>" name="id">
            <input type="hidden" value="<?=  $datar['img'];  ?>" name="file_lama">
            <div class="form-group">
              <label for="judul">Judul</label>
              <input type="text" class="form-control" id="judul" name="judul" required
                value="<?=  $datar['title'];  ?>">
            ...
            <div class="form-group">
              <label for="descripsi">Deskripsi</label>
              <textarea class="form-control" id="descripsi" name="descripsi" required>
                <?=  $datar['pesan'];  ?>
              </textarea>
            </div>
            <div class="form-group mt-2">
            ...
            <button type="submit" class="btn mt-2  btn-primary" name="edits"
              style="display: flex;justify-content: start;">Simpan</button>
          </form>
        </div>
        <div class="modal-footer">
